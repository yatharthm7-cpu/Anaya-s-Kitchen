      ...
      <header className="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-md shadow-sm transition-all duration-300">
        <nav className="flex justify-between items-center px-margin-desktop py-4 max-w-container-max mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button className="hidden lg:block font-label-md text-label-md text-on-surface-variant hover:text-primary transition-colors">Directions</button>
            <button className="bg-primary text-on-primary px-6 py-2 rounded-full font-label-md text-label-md hover:opacity-80 transition-all active:scale-95">Order Now</button>
          </div>
        </nav>
      </header>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-primary-container text-on-primary-container px-8 py-4 rounded-full font-label-md text-label-md hover:opacity-90 transition-all">Order Now</motion.button>
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="border border-surface-variant text-surface-variant px-8 py-4 rounded-full font-label-md text-label-md hover:bg-surface-variant hover:text-on-background transition-all">Get Directions</motion.button>
              </div>
            </motion.div>
          </motion.div>
        </section>
          ...
          <div className="max-w-container-max mx-auto px-margin-desktop">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-8">
                ...
                <button className="bg-primary text-on-primary px-10 py-4 rounded-full font-label-md text-label-md shadow-lg shadow-primary/20 hover:opacity-90 active:scale-95 transition-all flex items-center gap-2">
              ...
              <div className="rounded-2xl overflow-hidden h-[400px] shadow-lg relative bg-surface border border-outline-variant/30">
                <iframe
                  ...
                  loading="lazy"
                  allowFullScreen
                  src="https://maps.google.com/maps?q=Orchid%20Blues,%20G%20806,%20Shela,%20Ahmedabad,%20Gujarat%20380058&t=&z=15&ie=UTF8&iwloc=&output=embed"
                ></iframe>
              </div>
            </div>
          </div>
